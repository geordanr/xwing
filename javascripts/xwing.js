  ...
  exportObj.SquadBuilder = (function() {
    ...
    SquadBuilder.prototype.setupUI = function() {
      ...
      this.squad_name_save_button.click(function(e) {
        ...
        _this.squad_name_placeholder.text(name);
      ...
      this.backend_login_logout_button = $(this.container.find('button.backend-login-logout'));
      this.backend_login_logout_button.click(function(e) {
        e.preventDefault();
        if (_this.backend != null) {
          if (_this.backend.authenticated) {
            return _this.backend.logout();
          } else {
            return _this.backend.login();
          }
        }
      });
      ...
      this.backend_save_list_as_button.click(function(e) {
        var results, ___iced_passed_deferral, __iced_deferrals, __iced_k;
        __iced_k = __iced_k_noop;
        ___iced_passed_deferral = iced.findDeferral(arguments);
        e.preventDefault();
        if (_this.backend != null) {
          ...
          (function(__iced_k) {
            ...
            _this.backend.showSaveAsModal(_this, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return results = arguments[0];
                };
    ...
    SquadBuilder.prototype.onSquadLoadRequested = function(squad) {
      this.current_squad.id = squad.id;
      this.current_squad.name = squad.name;
    ...
    SquadBuilder.prototype.setBackend = function(backend) {
      ...
      return $(window).on('xwing-backend:authenticationChanged', function() {
        return _this.updateAuthenticationVisibility();
      });
    };

    SquadBuilder.prototype.updateAuthenticationVisibility = function() {
      if (this.backend.authenticated) {
