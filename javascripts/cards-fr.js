(function() {
  ...
  exportObj.translations.Français = {
    ...
    ui: {
      shipSelectorPlaceholder: "Sélectionnez un vaisseau",
      pilotSelectorPlaceholder: "Sélectionnez un pilote",
  ...
  exportObj.cardLoaders.Français = function() {
    ...
    pilot_translations = {
      "Wedge Antilles": {
        text: "Quand vous attaquez, réduisez la valeur d'agilité du défenseur de 1 (jusqu'à un minimim de 0)."
      },
      "Garven Dreis": {
