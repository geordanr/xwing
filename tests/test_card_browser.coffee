...
casper.test.begin "Card Browser", (test) ->
    ...
    common.assertInCardBrowserDisplay(test, 'wenn sich beim Ausführen eines Manövers die Basis eines Schiffs oder die Manöverschablone mit dem Marker überschneidet')
