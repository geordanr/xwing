...
casper.test.begin "Advanced Pursuit Lasers can only be fitted on Large ships", (test) ->
    ...
    common.assertNoMatch(test, "#rebel-builder #{common.selectorForUpgradeIndex(2, 7)}", 'Anti-Pursuit Lasers')
    common.assertNoMatch(test, "#rebel-builder #{common.selectorForUpgradeIndex(3, 3)}", 'Anti-Pursuit Lasers')
