(function() {
  var exportObj, modification, modification_name, pilot, pilot_name, title, title_name, upgrade, upgrade_name, _ref, _ref1, _ref2, _ref3, _ref4;
  ...
  _ref2 = exportObj.modifications;
  for (modification_name in _ref2) {
    modification = _ref2[modification_name];
    exportObj.modificationsById[modification.id] = modification;
  }

  exportObj.titlesById = {};

  _ref3 = exportObj.titles;
  for (title_name in _ref3) {
    title = _ref3[title_name];
